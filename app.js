...
function createNewTaskElement(taskString) {
    ...
    //input (checkbox)
    var inputCheckBox = document.createElement("input"); //checkbx
    //label
    var listItemLabel = document.createElement("p"); //label
    //input (text)
    var inputText = document.createElement("input");//text
    //button.edit
    ...
    inputCheckBox.className = "input input_checkbox";

    listItemLabel.innerText = taskString;
    listItemLabel.className = "list-item__label";

    inputText.type = "text";
    inputText.className = "input input_text";

    editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
    editButton.className = "button button_edit";

    deleteButton.className = "button button_delete";
    deleteButtonImg.className = "button-img_remove";
